...
Dim Nirvana_Tileset_ID_3 : Nirvana_Tileset_ID_3 = -1
...
Dim Nirvana_Tileset_Image_3 : Nirvana_Tileset_Image_3 = -1
...
Dim Nirvana_Tileset_Cuts[14] As Nirvana_TilesetCut
...
Function Nirvana_Tileset_0()
	...
	Nirvana_Tileset_Cuts[4].StartTile = 1
	Nirvana_Tileset_Cuts[4].NumRows = 1
	Nirvana_Tileset_Cuts[4].NumCols = 2
	Nirvana_Tileset_Cuts[4].Image_ID = Nirvana_MakeTileCut(TMP_CANVAS, Nirvana_Tileset_Image_0, 4, 32, 32)

	Nirvana_Tileset_Cuts[5].StartTile = 3
	Nirvana_Tileset_Cuts[5].NumRows = 4
	Nirvana_Tileset_Cuts[5].NumCols = 4
	Nirvana_Tileset_Cuts[5].Image_ID = Nirvana_MakeTileCut(TMP_CANVAS, Nirvana_Tileset_Image_0, 5, 32, 32)

	Nirvana_Tileset_Cuts[6].StartTile = 17
	Nirvana_Tileset_Cuts[6].NumRows = 2
	Nirvana_Tileset_Cuts[6].NumCols = 2
	Nirvana_Tileset_Cuts[6].Image_ID = Nirvana_MakeTileCut(TMP_CANVAS, Nirvana_Tileset_Image_0, 6, 32, 32)

	Nirvana_Tileset_Cuts[7].StartTile = 18
	Nirvana_Tileset_Cuts[7].NumRows = 3
	Nirvana_Tileset_Cuts[7].NumCols = 2
	Nirvana_Tileset_Cuts[7].Image_ID = Nirvana_MakeTileCut(TMP_CANVAS, Nirvana_Tileset_Image_0, 7, 32, 32)
...
Function Nirvana_Tileset_1()
	...
	Nirvana_Tileset_Cuts[8].StartTile = 25
	Nirvana_Tileset_Cuts[8].NumRows = 1
	Nirvana_Tileset_Cuts[8].NumCols = 3
	Nirvana_Tileset_Cuts[8].Image_ID = Nirvana_MakeTileCut(TMP_CANVAS, Nirvana_Tileset_Image_1, 8, 32, 32)
...
Function Nirvana_Tileset_3()
	If Nirvana_Tileset_ID_3 >= 0 Then
		Return Nirvana_Tileset_ID_3
	End If

	TMP_CANVAS = OpenCanvas( 1024, 1024, 0, 0, 1024, 1024, 1)

	If Nirvana_Tileset_Image_3 < 0 Then
		If OS$ = "WINDOWS" Then
			Nirvana_Tileset_Image_3 = LoadImage(NIRVANA_TILE_DIR$ + "spc_tiles.png")
		Else
			Nirvana_Tileset_Image_3 = LoadImage(NIRVANA_TILE_DIR$ + "spc_tiles.png")
		End If

		If Nirvana_Tileset_Image_3 >= 0 Then
			Push_N(Nirvana_Tileset_Image_Stack, Nirvana_Tileset_Image_3)
		End If
	End If

	Nirvana_Tileset_ID_3 = CreateTileSet(Nirvana_Tileset_Image_3, 32, 32)
	...
	Nirvana_Tileset_Cuts[9].StartTile = 1
	Nirvana_Tileset_Cuts[9].NumRows = 1
	Nirvana_Tileset_Cuts[9].NumCols = 2
	Nirvana_Tileset_Cuts[9].Image_ID = Nirvana_MakeTileCut(TMP_CANVAS, Nirvana_Tileset_Image_3, 9, 32, 32)

	Nirvana_Tileset_Cuts[10].StartTile = 18
	Nirvana_Tileset_Cuts[10].NumRows = 3
	Nirvana_Tileset_Cuts[10].NumCols = 2
	Nirvana_Tileset_Cuts[10].Image_ID = Nirvana_MakeTileCut(TMP_CANVAS, Nirvana_Tileset_Image_3, 10, 32, 32)

	Nirvana_Tileset_Cuts[11].StartTile = 1
	Nirvana_Tileset_Cuts[11].NumRows = 1
	Nirvana_Tileset_Cuts[11].NumCols = 1
	Nirvana_Tileset_Cuts[11].Image_ID = Nirvana_MakeTileCut(TMP_CANVAS, Nirvana_Tileset_Image_3, 11, 32, 32)

	Nirvana_Tileset_Cuts[12].StartTile = 2
	Nirvana_Tileset_Cuts[12].NumRows = 1
	Nirvana_Tileset_Cuts[12].NumCols = 1
	Nirvana_Tileset_Cuts[12].Image_ID = Nirvana_MakeTileCut(TMP_CANVAS, Nirvana_Tileset_Image_3, 12, 32, 32)
...
Function Nirvana_CreateTileMap(tset_name$, tmap_width, tmap_height) As Nirvana_TileMap
	...
	Case "gt"
		nv_tmap.Tileset_ID = Nirvana_Tileset_3()
		nv_tmap.TileMap_ID = CreateTileMap(nv_tmap.Tileset_ID, tmap_width, tmap_height)
		nv_tmap.Mask_Index = 3
		nv_tmap.Mask_Count = 0
